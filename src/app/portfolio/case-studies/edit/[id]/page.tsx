    ...
    <AdminLayout>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="text-sm text-gray-500">
          ...
          <Link href="/portfolio/case-studies" className="text-primary-500 hover:underline">Case Studies</Link> /{" "}
          <span>Edit</span>
        </div>
      </div>
      ...
      <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); alert("Case study updated!"); }}>
        ...
        <div className="flex gap-3">
          ...
          <Link href="/portfolio/case-studies" className="bg-gray-200 text-gray-700 px-8 py-2.5 rounded-lg font-medium hover:bg-gray-300 transition-all inline-flex items-center">Cancel</Link>
        </div>
      </form>
    </AdminLayout>
  );
